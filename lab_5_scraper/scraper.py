...
from core_utils.article.io import to_meta, to_raw, prepare_environment
...
class Config:
    ...
    def _validate_config_content(self) -> None:
        ...
        if not isinstance(self._config_data.total_articles, int) or self._config_data.total_articles < 1:
